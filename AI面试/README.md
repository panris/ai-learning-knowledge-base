...
| 专题 | 题数 | 内容 |
|------|------|------|
| [📊 机器学习基础](./机器学习基础.md) | 24+ | 传统 ML 算法、特征工程、评估指标、深度学习入门 |
| [🧠 LLM 基础](./LLM基础.md) | 25+ | Transformer、注意力、生成推理、MoE、蒸馏 |
| [⚡ 推理优化专题](./推理优化专题.md) | 20+ | 量化、PagedAttention、vLLM/TGI、多卡推理、成本优化 |
...
| [🧠 大模型预训练](./大模型预训练.md) | 22+ | 数据准备、Scaling Law、架构、分布式训练 |
...
| Agent 与工具调用 | 4 题 | ReAct、MCP、记忆系统、代码沙箱安全 |
| 模型部署与服务化 | 3 题 | vLLM/TGI/TRT-LLM、Gateway、限流调度 |
...
**Q19：大模型推理加速有哪些方法？**
> 量化（GPTQ/AWQ/INT8/INT4）、KV Cache、Batch 优化、投机解码、蒸馏
